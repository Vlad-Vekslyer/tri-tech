      ...
      <div className="ourTeam-content">
        ...
        <div className="ourTeam-content-section">
          ...
          <p className="ourTeam-paragraph">
            ...
            markets. He worked 6 years in NBA for the team Vancouve Grizzlies,<span className="mobile-hidden">
      ...
      <div className="ourTeam-content">
        ...
        <div className="ourTeam-content-section">
          ...
          <p className="ourTeam-paragraph">
            ...
            experience with his focus on building and financing start-ups<span className="mobile-hidden"> in the
